...
* `CreateEntry` - should create a new Journal Entry for a current user. A shape of data send by a client application to this function can be found in the `CreateEntryRequest.ts` file
